...
Output berupa HTML (.html) yang mengikuti struktur file html.html.
...
Cara pakai:
    ...
    python generate_surat_pernyataan.py "TPP P3K JULI 2026 SMKN 1 KOBA.xlsm" -t PPPK \
        -o "SURAT_PERNYATAAN_P3K.html"

Output:
    File HTML (.html) berisi surat pernyataan dengan format standir
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Generate SURAT_PERNYATAAN_PNS / SURAT_PERNYATAAN_P3K (.html) dari sheet sptjm Excel TPP")
    ...
    parser.add_argument("-f", "--format", default="html", choices=["html"],
                        help="Format output: html (default: html)")
    parser.add_argument("-o", "--output", default=None,
                        help="Path output (default: SURAT_PERNYATAAN_PNS.html atau SURAT_PERNYATAAN_P3K.html)")
    ...
    if args.output:
        ...
        if args.type == "PPPK":
            output_path = xlsx_path.with_name("SURAT_PERNYATAAN_P3K.html")
        else:
            output_path = xlsx_path.with_name("SURAT_PERNYATAAN_PNS.html")
